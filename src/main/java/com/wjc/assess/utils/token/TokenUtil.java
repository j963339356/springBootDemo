...
public class TokenUtil {
    ...
    //根据token获取
    public static <T>Object getUser(String token){
        Object user = redis.get(token);
        redis.expire(token,15);
        return (T)user;
    }
    public static <T>Object getUser(HttpServletRequest httpServletRequest)
    {
